---
routeSlug: 10
title: 如何写一个好的skill 让你的效率加倍
type: 分享
createdAt: "2026-07-18 01:07:00"
updatedAt: "2026-07-18 01:07:00"
---
...
![7e147aea026f476a69fcd84c13dd4b13](https://img.187360.xyz/img/ea8183be307cb7740217009d83a5bec102841fdb.jpeg)
...
![image](https://img.187360.xyz/img/1cd1842571fa411c342001147daa67ed381b1d59_2_690x183.png)
...
![:warning:](https://img.187360.xyz/img/warning.png) 这个非常重要。
...
![image](https://img.187360.xyz/img/a93f4d2bb27aab2fd3be965214fccf025dee29e7_2_690x261.png)
...
![image](https://img.187360.xyz/img/21794d47b7308e9966b35824992d398f3d089635_2_690x161.png)
...
![image](https://img.187360.xyz/img/09afea81ea022fa223c63fd4b07404255c1e050f.png)
...
让你的skiil整合到一起,而不是无根的浮萍
一个好的 skill 不是“把知识都装进去”，而是告诉 agent：

1. **什么时候该用这个 skill**

  比如用户说哪些关键词、遇到哪些文件类型、出现哪些任务场景时触发。
2. **什么时候不该用**

  这点很重要。否则 skill 会过度触发，把简单问题复杂化。
3. **用到哪一步该读什么**

  `SKILL.md` 最好只是入口和路线图，不要塞满所有细节。
...
![image](https://img.187360.xyz/img/3f6320bc0ae345ee31794efcd1d4b4bbc5d2bc74_2_690x245.png)
...
![image](https://img.187360.xyz/img/a99c4b4632201435c8008cb45ce05243e44ccbf4_2_690x200.png)
...
![image](https://img.187360.xyz/img/75e07867624ea15bf9931edfbda8086219fe7df2_2_690x161.png)
...
![image](https://img.187360.xyz/img/d2b8e9f3b3e25a375a42a760a9af3e89214e4213_2_689x150.png)
...
![image](https://img.187360.xyz/img/913123ca01ad41ece27fc5ea1ee26b4c92cb5f72_2_517x191.png)

**一个 Description 写不好的 Skill，等同于不存在。**

![:warning:](https://img.187360.xyz/img/warning.png)如果你有 Cursor 注册入口 `.cursor/skills/<name>/SKILL.md`,它的 description **必须和主 SKILL.md 完全一致**。否则两边漂移 = Cursor 用一套判据,其它 harness 用另一套,激活随机化。
...
![image](https://img.187360.xyz/img/6a32f356594c8fc75b9863998ddbc4f39f0d4def_2_689x227.png)
...
![:cross_mark:](https://img.187360.xyz/img/cross_mark.png) 常见的错误写法：
...
![:white_check_mark:](https://img.187360.xyz/img/white_check_mark.png) 正确的做法就是 上面提到的的三块模板——路由表、Auto-Triggers、Red Flags 都是**结构化内容**，压缩器会保留更多。用通俗的话来说,多让Agent后面多自己提到,而不是仅仅靠上下文来维护内容
...
![image](https://img.187360.xyz/img/f4b5fd40e750a8df0c157eac0675014e3c0af8a1.png)
...
![image](https://img.187360.xyz/img/f4aecd93d87a431c7b9d02fb28fd5d340607c7d6_2_690x176.png)
...
![image](https://img.187360.xyz/img/454a2d03ad11ab13feda6169df2b6648482967dd_2_690x376.png)
...
![image](https://img.187360.xyz/img/66b3abc6eb3ce58fa925f383270516bbc2ee64cf_2_690x238.png)
...
![image](https://img.187360.xyz/img/058664e109e32f61217e3fd7de3391b446a60855_2_690x148.png)
...
![image](https://img.187360.xyz/img/d47f1b06ee65dbe6be0e498bc4334b8d398da863_2_690x255.png)
...
![image](https://img.187360.xyz/img/702b5d587dc2c37b50fc0d736f00e35bcd3c8602_2_690x189.png)
...
![image](https://img.187360.xyz/img/87ba6f3e9ac5cf658f6f5d72e29f483cac55c424_2_690x90.png)
...
![image](https://img.187360.xyz/img/9adb567d89cb6199e04c2203d5184feb39839cbf_2_690x193.png)
...
![image](https://img.187360.xyz/img/5b9df4adb96b6eba9d43b1a2154291cee59dfb07_2_690x224.png)
...
![image](https://img.187360.xyz/img/2b932bb0ff5a48d5f385c10c95ccffd92f2b7c7c_2_690x243.png)
...
![image](https://img.187360.xyz/img/2b348543fb458d162011d596f9d1f499c77a9099_2_690x454.png)
...
防止 Agent 把 skill 写成日记本![image](https://img.187360.xyz/img/36781f68063168828f4425828720b58629b9b75d_2_690x315.png)
...
**![:white_check_mark:](https://img.187360.xyz/img/white_check_mark.png) 应该做的**：在 `references/frontend-pitfalls.md` 里**加一段**"ServiceStore / removeStore 卸载时的竞态"的**泛化教训**——什么时候触发、根因、怎么避免。这条通过 2/3 门槛（可重复 + 代价高 + 代码不可见）。

**![:cross_mark:](https://img.187360.xyz/img/cross_mark.png) 应该删掉的**：`references/2026-04-14-session-notes.md` 这种文件整份删——每一行都是项目叙事，不是规则、不是工作流、不是可复用坑点。
...
![image](https://img.187360.xyz/img/5bb667864316279da0a856a1e58a67b3b2b06688_2_690x470.png)
